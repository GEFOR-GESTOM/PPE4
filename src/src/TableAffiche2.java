...
public class TableAffiche2 extends JScrollPane{
    ...
    public TableAffiche2(String[] COLONNEImport, Object variable, PanelAffichage panAffiImport,String search)
    {
